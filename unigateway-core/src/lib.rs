...
pub use request::{
    ...
    ProxyChatRequest, ProxyEmbeddingsRequest, ProxyResponsesRequest, REASONING_TEXT_ENCODING_KEY,
    REASONING_TEXT_ENCODING_XML_THINK_TAG, StructuredMessage, THINKING_SIGNATURE_PLACEHOLDER_VALUE,
    ...
    is_gateway_only_field_key, is_placeholder_thinking_signature,
    is_tool_choice_upstream_rejection, merge_forwardable_extra, normalize_tool_choice,
