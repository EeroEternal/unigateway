...
use unigateway_config::routing::resolve_upstream;
use unigateway_config::{ModeProvider, ModeView};

use crate::modes::{load_mode_views, mode_providers_for, select_mode, supported_protocols};

pub fn route_strategy_summary(mode: &ModeView, providers: &[&ModeProvider]) -> String {
...
pub fn render_route_explanation(mode: &ModeView) -> String {
