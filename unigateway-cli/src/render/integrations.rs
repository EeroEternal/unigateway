...
use unigateway_config::ModeView;
...
pub fn parse_integration_tool(tool: Option<&str>) -> Result<IntegrationTool> {
...
pub fn render_integration_output_for_tool(
    ...
    let bind_addr = match bind_override {
        ...
        None => user_bind_address(&crate::bind_from_env()),
    };
